    ...
    categories: [
      ...
      // ── 6. Garden Equipment ──
      {
        ...
        products: [
          ...
          { name: 'Milwaukee 3016-20PS', price: "$249.00", sku: "MIL-3016-20PS", description: 'M18 FUEL 10" Pole Saw with QUIK-LOK Attachment Capability (Tool-Only). Reaches up to 13 ft. Automatic oiler system.', image: `${HCDN}/3a6418f3-df2b-467e-a2b0-aa44b84aede1/svn/milwaukee-cordless-pole-saws-3016-20ps-64_600.jpg` },
