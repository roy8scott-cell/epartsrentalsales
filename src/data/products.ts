    ...
    categories: [
      {
        name: "Rotary Hammers",
        products: [
          { name: "Makita HR4041C", price: "$634.95", sku: "MAK-HR4041C", description: 'Martillo Rotativo de 1-9/16", acepta brocas Spline.', image: `${MCDN}/hr4/97fbfe39-1630-4576-ba10-d85cd6e8519c_hr4041c_k_1500px.png` },
          { name: "Makita HR2641X1", price: "$299.95", sku: "MAK-HR2641X1", description: 'Kit Martillo Rotativo SDS-Plus de 1" (8 Amp) + Esmeril Angular de 4-1/2".', image: `${MCDN}/hr2/7dd522a4-2814-425f-b4f2-2791d2a2bb3c_hr2641x1_k_1500px.png` },
          { name: "Makita HR2811F", price: "$394.95", sku: "MAK-HR2811F", description: 'Martillo Rotativo de 1-1/8", acepta brocas SDS-PLUS.', image: `${MCDN}/hr2/64fcb31b-f282-4009-aab6-a42956b2b963_hr2811f_k_1500px.png` },
          { name: "Makita XRH04Z", price: "$229.95", sku: "MAK-XRH04Z", description: 'Martillo Rotativo Inalámbrico SDS-Plus de 7/8" 18V LXT (Solo herramienta).', image: `${MCDN}/xrh/42c3feff-641f-4aa1-b070-8cd163df8220_xrh04z_p_1500px.png` },
        ],
      },
      {
        name: "Demolition Hammers",
        products: [
          { name: "Makita HM1307CB", price: "$1,359.95", sku: "MAK-HM1307CB", description: 'Martillo Demoledor de 35 lb, 14 Amp, Hexagonal 1-1/8", Vel. Variable, LED.', image: `${MCDN}/hm1/01b6d0e9-0260-439a-abc4-442b08ef7d56_hm1307cb_k_1500px.png` },
          { name: "Makita HM0810B", price: "$589.95", sku: "MAK-HM0810B", description: "Martillo Demoledor de 13 lb, Brocas Spline.", image: `${MCDN}/hm0/58c3f24e-58a6-4d2b-a667-06c85ca34852_hm0810b_k_1500px.png` },
          { name: "Makita HM1211B", price: "$879.95", sku: "MAK-HM1211B", description: 'Martillo Demoledor de 20 lb, acepta brocas Hexagonales de 3/4".', image: `${MCDN}/hm1/2a5d5d8c-2109-4057-b4d2-284ee9669e81_hm1211b_k_1500px.png` },
          { name: "Makita HM1214C", price: "$1,199.95", sku: "MAK-HM1214C", description: "Martillo Demoledor AVT de 27 lb, acepta brocas SDS-MAX.", image: `${MCDN}/hm1/975f21eb-27a7-42ee-b648-1de2088de441_hm1214c_k_1500px.png` },
        ],
      },
      {
        name: "Garden Equipment",
        products: [
          { name: "Makita XUX02SM1X1", price: "$299.95", sku: "MAK-XUX02SM1X1", description: 'Kit de Eje Acoplable Inalámbrico 18V LXT c/ Desbrozadora de 13" (4.0Ah).', image: `${MCDN}/xux/309b5b6a-7289-4af9-a762-972b22ce036b_xux02sm1x1_k_1500px.png` },
          { name: "Makita XUX02SM1X3", price: "$349.95", sku: "MAK-XUX02SM1X3", description: 'Kit Eje Acoplable 18V LXT c/ Desbrozadora de 13" y Soplador.', image: `${MCDN}/xux/cea9295f-f8d9-426e-a3cd-7cd101ca96d8_xux02sm1x3_k_1500px.png` },
          { name: "Makita XUX02SM1X4", price: "$289.95", sku: "MAK-XUX02SM1X4", description: 'Kit Eje Acoplable 18V LXT c/ Desbrozadora y Sierra de Pértiga de 10".', image: `${MCDN}/xux/34860bcf-5bc4-46d4-aadd-e35aafac37fd_xux02sm1x4_k_1500px.png` },
          { name: "Makita XUX02SM1X5", price: "$499.95", sku: "MAK-XUX02SM1X5", description: "Kit Eje Acoplable 18V LXT c/ Desbrozadora, Sierra de Pértiga y Cortasetos.", image: `${MCDN}/xux/1a9bcd20-339f-45d3-972e-1f119582e25c_xux02sm1x5_k_1500px.png` },
          { name: "Makita XUX02SM1X6", price: "$599.95", sku: "MAK-XUX02SM1X6", description: "Kit Eje Acoplable 18V LXT c/ Desbrozadora, Sierra, Cortasetos y Soplador.", image: `${MCDN}/xux/44a04770-a9f9-41f7-90c6-e3dc982d0a17_xux02sm1x6_k_1500px.png` },
          { name: "Makita XBU03SM1", price: "$299.95", sku: "MAK-XBU03SM1", description: "Kit Soplador Inalámbrico 18V LXT (116 MPH, 459 CFM).", image: `${MCDN}/xbu/b81aab02-5c31-432a-ab23-208f293d7f32_xbu03sm1_k_1500px.png` },
          { name: "Makita XCU10SM1", price: "$319.95", sku: "MAK-XCU10SM1", description: 'Motosierra de Mango Superior 10" 18V LXT (Solo herramienta).', image: `${MCDN}/xcu/a8d79846-8a6e-4d5a-966a-8b57d25533dc_xcu10sm1_k_1500px.png` },
        ],
      },
      {
        name: "Drills & Drivers",
        products: [
          { name: "Makita XPH12Z", price: "$159.95", sku: "MAK-XPH12Z", description: 'Taladro Percutor Inalámbrico 1/2" 18V LXT (Solo herramienta).', image: `${MCDN}/xph/d95a3190-0b96-4e7b-85ef-9c139dbb28b5_xph12z_p_1500px.png` },
          { name: "Makita XDT14Z", price: "$169.95", sku: "MAK-XDT14Z", description: 'Atornillador de Impacto 1/4" 18V LXT 3 Velocidades (Solo herramienta).', image: `${MCDN}/xdt/7cb31bcc-d235-4ba7-9670-c42276973981_xdt14z_p_1500px.png` },
          { name: "Makita XFD10SY", price: "$179.95", sku: "MAK-XFD10SY", description: 'Kit Taladro Atornillador Compacto 1/2" 18V LXT (1.5 Ah).', image: `${MCDN}/xfd/65439e2c-07a4-4112-a1b4-ed788831f336_xfd10sy_k_1500px.png` },
          { name: "Makita XDT11SY", price: "$179.95", sku: "MAK-XDT11SY", description: 'Kit Atornillador de Impacto Compacto 1/4" 18V LXT (1.5 Ah).', image: `${MCDN}/xdt/a9bfb623-1228-4e13-9ea8-811b9e6e3fd3_xdt11sy_k_1500px.png` },
          { name: "Makita XT296SMR", price: "$289.95", sku: "MAK-XT296SMR", description: "Kit Combo Taladro Percutor y Atornillador de Impacto 18V LXT (2 Herr.).", image: `${MCDN}/xt2/4b08398b-cce8-4be3-92b0-1c77bcdbc3d8_xt296smr_k_1500px.png` },
        ],
      },
      {
        name: "Impact Wrenches & Ratchets",
        products: [
          { name: "Makita XWT08Z", price: "$339.95", sku: "MAK-XWT08Z", description: 'Llave de Impacto de Alto Torque 1/2" 18V LXT (Solo herramienta).', image: `${MCDN}/xwt/9b2a2d7f-cea4-4ac6-af2d-0d25742e8790_xwt08z_p_1500px.png` },
          { name: "Makita XWT08T", price: "$629.95", sku: "MAK-XWT08T", description: 'Kit Llave de Impacto de Alto Torque 1/2" 18V LXT c/ 2 Baterías.', image: `${MCDN}/xwt/3183a24f-2f8f-4233-ac8f-dc53721f1932_xwt08t_k_1500px.png` },
          { name: "Makita XWT04S1", price: "$289.95", sku: "MAK-XWT04S1", description: 'Kit Llave de Impacto Cuadrada 1/2" 18V LXT (3.0Ah).', image: `${MCDN}/xwt/28c8f88a-c0b7-4b61-839c-b2e669ab9694_xwt04s1_k_1500px.png` },
          { name: "Makita XRW01Z", price: "$199.95", sku: "MAK-XRW01Z", description: 'Matraca Inalámbrica 3/8" / 1/4" 18V LXT (Solo herramienta).', image: `${MCDN}/xrw/5351f1a0-223b-402f-94dc-de8ab898c901_xrw01z_p_1500px.png` },
        ],
      },
      {
        name: "Grinders",
        products: [
          { name: "Makita 9557PB", price: "$109.95", sku: "MAK-9557PB", description: 'Esmeril Angular de 4-1/2" con Interruptor de Paleta.', image: `${MCDN}/955/95b8b5bb-f9cd-42a0-9331-eb3de17cf43e_9557pb_p_1500px.png` },
          { name: "Makita GA7021", price: "$229.95", sku: "MAK-GA7021", description: 'Esmeril Angular de 7" con Interruptor AC/DC.', image: `${MCDN}/ga7/ef50e1f5-ee92-48ae-a32c-0d3175abf62f_ga7021_p_1500px.png` },
          { name: "Makita XAG26Z", price: "$209.95", sku: "MAK-XAG26Z", description: 'Esmeril Angular X-LOCK 5" 18V LXT, Interruptor Paleta con AFT.', image: `${MCDN}/xag/bd2a2a59-1098-4bc7-b31e-8954e8e96bb2_xag26z_p_1500px.png` },
        ],
      },
      {
        name: "Saws & Cutters",
        products: [
          { name: "Makita LW1401", price: "$314.95", sku: "MAK-LW1401", description: 'Tronzadora de Metales de 14".', image: `${MCDN}/lw1/b6168d1b-e173-49d5-9746-e97a65b0b71d_lw1401_p_1500px.png` },
          { name: "Makita XSH04ZB", price: "$209.95", sku: "MAK-XSH04ZB", description: 'Sierra Circular Sub-Compacta 6-1/2" 18V LXT (Solo herramienta).', image: `${MCDN}/xsh/08251556-83ad-480d-9406-8dd5940ef32d_xsh04zb_p_1500px.png` },
          { name: "Makita XEC01PT1", price: "$1,099.95", sku: "MAK-XEC01PT1", description: 'Kit Cortadora de Concreto 9" 18V X2 LXT con 4 Baterías.', image: `${MCDN}/xec/cc62df9a-71ab-4a76-850e-5aaeddfdddba_xec01pt1_k_1500px.png` },
          { name: "Makita GEC01PL", price: "$2,269.95", sku: "MAK-GEC01PL", description: 'Kit Cortadora de Concreto 14" 40V max X2 XGT.', image: `${MCDN}/gec/e931e332-d5a0-4310-b2b0-bfc88f701eb5_gec01pl_k_1500px.png` },
        ],
      },
    ],
  },
