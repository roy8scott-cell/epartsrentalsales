...
const es: Translations = {
  ...
  cat_podadoras: "Tractores",
  cat_podadoras_desc: "Piezas para tractores de césped, cuchillas, filtros y más.",
...
const en: Translations = {
  ...
  cat_podadoras: "Tractors",
  cat_podadoras_desc: "Parts for lawn tractors, blades, filters and more.",
