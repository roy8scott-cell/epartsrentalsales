        ...
        <section className="container py-12 md:py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            <div className="bg-card border border-border rounded-2xl p-6 space-y-4">
              <h2 className="font-heading font-bold text-lg text-foreground">{t.contacto_info_title}</h2>
            ...
            <div className="bg-card border border-border rounded-2xl p-6 space-y-4">
              <h2 className="font-heading font-bold text-lg text-foreground">{t.contacto_location_title}</h2>
              ...
              <a
                ...
                className="inline-block bg-primary text-primary-foreground px-5 py-2.5 rounded-xl font-heading font-bold text-sm hover:brightness-110 transition"
              >
                {t.contacto_maps_btn}
              </a>
            </div>
